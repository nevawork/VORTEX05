    ...
    async def full_server_recovery (self ,guild ):
        ...
        try :
            ...
            try :
                ...
                "[chart] Restoring server structure from backup...")
            except :
                pass 
            ...
            for ch_data in snapshot ['text_channels']:
                try :
                    ...
                    if recovery_channel :
                        await recovery_channel .send (f"[memo] Restored text channel: **#{ch_data['name']}**")
        ...
        while attempt <retries and not new_channel :
            try :
                ...
                if isinstance (channel ,discord .TextChannel ):
                    ...
                    overwrites =overwrites ,
                    reason ="Anti-Nuke: Channel restored after unDeveloper: NEVA "3pa8")
