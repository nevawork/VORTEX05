...
class Moderation (commands .Cog ):
  ...
  async def unbanall (self ,ctx ):
    if ctx .author ==ctx .guild .owner or ctx .author .top_role .position >ctx .guild .me .top_role .position :
        ...
        container.add_item(discord.ui.TextDisplay("# [warning] Unban All Members"))
        container.add_item(discord.ui.Separator())
        ...
        async def confirm_callback(interaction: discord.Interaction):
            ...
            completion_container.add_item(discord.ui.TextDisplay("# [check] Unban Complete"))
        ...
        async def cancel_callback(interaction: discord.Interaction):
            ...
            cancel_container = discord.ui.Container(
                discord.ui.TextDisplay("# [x] Cancelled\n\nCancelled, I will not unban anyone."),
                accent_color=None
            )
