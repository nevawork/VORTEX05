...
class Owner (commands .Cog ):
    ...
    async def server_alert (self ,ctx ,*,message :str ):
        ...
        title ="[chart] Server Alert Results",
        color =0x00ff00 if failed_count ==0 else 0xffaa00 ,
        timestamp =discord .utils .utcnow ()
        )
        result_embed .add_field (name ="[check] Successful",value =str (success_count ),inline =True )
        result_embed .add_field (name ="[x] Failed",value =str (failed_count ),inline =True )
